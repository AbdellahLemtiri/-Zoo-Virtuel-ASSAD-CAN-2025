    ...
    <main class="flex-1 flex flex-col h-screen overflow-hidden relative">
        ...
        <div class="flex-1 overflow-y-auto bg-background-light dark:bg-background-dark">
            <div class="max-w-4xl mx-auto w-full px-6 py-8 flex flex-col gap-8">
                ...
                <form method="POST" action="admin_add_animal.php"  class="flex flex-col gap-8">
                    ...
                    <section class="p-6 bg-surface-light dark:bg-surface-dark rounded-xl shadow-xl border border-gray-100 dark:border-gray-800">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="url" name="image" placeholder="url de l'image" class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-primary/10 file:text-primary hover:file:bg-primary/20" />
                            </div>
